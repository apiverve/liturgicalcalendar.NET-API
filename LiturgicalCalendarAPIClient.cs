...
namespace APIVerve
{
    public class LiturgicalCalendarAPIClient
    {
        ...
        public LiturgicalCalendarAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public LiturgicalCalendarAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
